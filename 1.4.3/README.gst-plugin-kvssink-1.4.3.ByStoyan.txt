...
Set access-key and secret-key in the command (for more parameters google 'kvssink parameters') and run it:
...
To have managed logging, make sure that kvs_log_configuration file is located in the active directory, else set log-config in kvsink parameters.
